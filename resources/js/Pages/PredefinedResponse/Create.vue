...
function submit() {
    ...
    router.post(route('predefined-responses.store'), form.value, {
        preserveScroll: true,
        onSuccess: () => {
            form.value = { title: '', response: '', is_active: true, sort_order: 0 };
        },
        onError: (err) => {
            errors.value = err;
...
<template>
    <Head title="Create Predefined Response" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                Add New Predefined Response
            </h2>
        </template>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-end gap-4">
                                ...
                                >
                                    ...
                                    {{ submitting ? 'Creating...' : 'Create Response' }}
                                </button>
                            </div>
                        </form>
                    </div>
